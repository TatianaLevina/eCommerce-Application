        ...
        <Card>
          <Flex>
            ...
            <Flex gap="small" vertical style={{ maxWidth: '60%', marginLeft: '20px' }}>
              ...
              <Text>
                A detailed introduction of the development team is created and placed in the About Us page 🗺️. The
                introduction includes the names 📛, roles/job titles 🎯, a short bio 📄, a clear and relevant photo 🖼️,
                and a link to the GitHub profile 🌐 of each team member.
              </Text>
              <Text>
                Each members significant contributions to the project are highlighted in the introduction 🏗️. The
                description demonstrates how the teams effective collaboration led to the projects successful completion
                🎉.
              </Text>
